...
class ImagePickerHandler:NSObject{
    ...
    func showAttachmentActionSheet(vc: UIViewController) {
        ...
        let actionSheet = UIAlertController(title: "", message: "Choose Image", preferredStyle: .actionSheet)
   ...
   private func authorisationStatus(pickerType: PickerType, vc: UIViewController){
        currentVC = vc
    ...
    //MARK: - SETTINGS ALERT
    private func addAlertForSettings(_ attachmentTypeEnum: PickerType){
        DispatchQueue.main.async {
