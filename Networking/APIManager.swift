...
//    
//  
//    func uploadFile<T>(type: EndPointType, params: Parameters? = nil,imageToUpload: UIImage?, success: @escaping (T?, UIImage?)->(),_ failure: @escaping (_ error: ErrorObject?)->()) -> UploadRequest where T: Codable {
